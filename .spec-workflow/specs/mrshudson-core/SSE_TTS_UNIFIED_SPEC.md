...
| 待办 | 优先级 | 状态 |
|------|--------|------|
| SseFormatter 新增方法（含 conversationId、messageId 参数） | **P0** | ✅ 已完成 |
| StreamChatService 重构 | **P0** | ✅ 已完成 |
| TTS Provider 策略模式重构 | **P0** | ✅ 已完成 |
...
| 待办 | 优先级 | 状态 |
|------|--------|------|
| SseClient 新增事件 | **P0** | ✅ 已完成 |
| Message 接口更新 | **P0** | ✅ 已完成 |
| ChatRoom 状态管理 | **P0** | ✅ 已完成 |
| 发送期间输入框 disable / SSE 完成后恢复 | **P0** | ✅ 已完成 |

### 16.3 Android

| 待办 | 优先级 | 状态 |
|------|--------|------|
| StreamEvent 新增类型 | **P0** | ✅ 已完成 |
| SSE 解析更新 | **P0** | ✅ 已完成 |
| Message 状态更新 | **P0** | ✅ 已完成 |
| ViewModel 处理 | **P0** | ✅ 已完成 |
| conversationId 解析修复 | **P0** | ✅ 已完成 |
